  ...
  return (
    <Section>
      <Container>
        ...
        <Paragraph>
          Strømsjef.no er ikke ansvarlig for tap eller skade som følger av bruk av tjenestene eller informasjonen på nettstedet, heller ikke ved manglende tilgjengelighet av informasjon. Vi garanterer ikke at nettsiden alltid vil være tilgjengelig eller fri for feil.
        </Paragraph>
        <Paragraph>
        ...
        <SectionTitle>10. Personvern</SectionTitle>
        <Paragraph>
          Vi behandler dine personopplysninger i henhold til vår personvernpolicy. Les mer om hvordan vi håndterer dine data i vår <Mail href="/integritetspolicy">personvernpolicy</Mail>.
        </Paragraph>

        <SectionTitle>11. Lovvalg</SectionTitle>
        <Paragraph>
          Disse vilkårene er underlagt norsk lov. Eventuelle tvister skal løses ved forhandling, og ved manglende enighet, ved norske domstoler.
        </Paragraph>
      </Container>
    </Section>
  );
